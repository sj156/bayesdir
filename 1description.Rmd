...
usethis::create_package(
  ...
  fields = list(
    ...
    Version = "0.0.0.9000",
    Title = "bayesdir",
    Description = "Bayesian dynamic network models",
    `Authors@R` = person(
      given = "Sheng",
      family = "Jiang",
...
usethis::use_package("rstiefel", type = "depends")
usethis::use_package("circglmbayes", type = "depends")
usethis::use_package("circular", type = "depends")
